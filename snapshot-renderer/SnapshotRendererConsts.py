...
HeadDict = {'dls': 'phase_3/models/char/tt_a_chr_dgm_shorts_head_',
            'dss': 'phase_3/models/char/tt_a_chr_dgm_skirt_head_',
            'dsl': 'phase_3/models/char/tt_a_chr_dgs_shorts_head_',
            'dll': 'phase_3/models/char/tt_a_chr_dgl_shorts_head_',
            'c': 'phase_3/models/char/cat-heads-',
            'h': 'phase_3/models/char/horse-heads-',
            'm': 'phase_3/models/char/mouse-heads-',
            'r': 'phase_3/models/char/rabbit-heads-',
            'f': 'phase_3/models/char/duck-heads-',
            'p': 'phase_3/models/char/monkey-heads-',
            'b': 'phase_3/models/char/bear-heads-',
            's': 'phase_3/models/char/pig-heads-'}
...
PartSizeDict = {'short':250, 'medium':500, 'long':1000}

EyelashDict = {'d': 'phase_3/models/char/dog-lashes',
               'c': 'phase_3/models/char/cat-lashes',
               'h': 'phase_3/models/char/horse-lashes',
               'm': 'phase_3/models/char/mouse-lashes',
               'r': 'phase_3/models/char/rabbit-lashes',
               'f': 'phase_3/models/char/duck-lashes',
               'p': 'phase_3/models/char/monkey-lashes',
               'b': 'phase_3/models/char/bear-lashes',
               's': 'phase_3/models/char/pig-lashes'}

DogMuzzleDict = {'dls': 'phase_3/models/char/dogMM_Shorts-headMuzzles-',
                 'dss': 'phase_3/models/char/dogMM_Skirt-headMuzzles-',
                 'dsl': 'phase_3/models/char/dogSS_Shorts-headMuzzles-',
                 'dll': 'phase_3/models/char/dogLL_Shorts-headMuzzles-'}

legsAnimDict = {'neutral': 'phase_3/models/char/tt_a_chr_dgs_shorts_legs_neutral.bam'}
torsoAnimDict = {'neutral': 'phase_3/models/char/tt_a_chr_dgm_shorts_torso_neutral.bam'}
